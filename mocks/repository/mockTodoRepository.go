...
// Source: github.com/ykotanli/repository (interfaces: TodoRepository)
...
func (m *MockTodoRepository) Delete(arg0 string) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoRepository) DeleteAll() (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTodoRepositoryMockRecorder) DeleteAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAll", reflect.TypeOf((*MockTodoRepository)(nil).DeleteAll))
}

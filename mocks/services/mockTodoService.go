...
// Source: github.com/ykotanli/services (interfaces: TodoService)
...
import (
	...
	dto "github.com/ykotanli/dto"
	models "github.com/ykotanli/models"
)
...
func (m *MockTodoService) TodoDelete(arg0 string) (*dto.TodoDTO, error) {
	m.ctrl.T.Helper()
...
// TodoDeleteAll mocks base method.
func (m *MockTodoService) TodoDeleteAll() (*dto.TodoDTO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TodoDeleteAll")
	ret0, _ := ret[0].(*dto.TodoDTO)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TodoDeleteAll indicates an expected call of TodoDeleteAll.
func (mr *MockTodoServiceMockRecorder) TodoDeleteAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TodoDeleteAll", reflect.TypeOf((*MockTodoService)(nil).TodoDeleteAll))
}
